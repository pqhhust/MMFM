...
def main(
    ...
    if dgp == "a":
        ...
        if classifier_free & conditional_model & (p_unconditional > 0.0):
            train_loader_no_label, _, _, _, _, _, _, _, _, _, _ = f_data_loader(
                hvg=hvg,
                use_pca=use_pca,
                coupling="ot",
                batch_size=batch_size,
...
if __name__ == "__main__":
    ...
    # seeds = [0]
    # x_latent_dims = [64, 128]  # , 128
    # time_embed_dims = [64, 128]  # , 128
    # cond_embed_dims = [64, 128]  # , 128
    # n_samples_per_c_in_b = [100]
    # p_unconditional = [0.0, 0.2]
    # lr = [1e-2, 1e-3, 1e-4]
    # use_pca = [10, 25]

    # # Use itertools.product to generate combinations
    # combinations = itertools.product(
    #     seeds, x_latent_dims, time_embed_dims, cond_embed_dims, n_samples_per_c_in_b, p_unconditional, lr, use_pca
    # )

    # # Iterate over the combinations
    # for combination in combinations:
    #     seed, x_latent_dim, time_embed_dim, cond_embed_dim, n_samples_per_c_in_b, p_unconditional, lr, use_pca = (
    #         combination
    #     )
    #     main(
    #         seed=seed,
