...
if __name__ == "__main__":
    main()
    # dgp_waves_i_0_0.01_0.1_3_False_0.0_50_8_8_8_None_xavier_normal_LeakyReLU_cosine_linear_True_False_free_False_False_300_cot_False_True_None_0.5_0.0_0.025_2_adam_False_0.0_False_False_emd_totcfm
    # for p_unconditional in [0.0, 0.2]:
    #     for seed in [0, 1, 2]:
    #         for x_latent_dim in [8, 16, 32]:
    #             for flow_variance in [0.1, 0.01, 0.001]:
    ...
    #                         ns_per_t_and_c=50,
    #                         x_latent_dim=x_latent_dim,
    #                         time_embed_dim=x_latent_dim,
    #                         cond_embed_dim=x_latent_dim,
